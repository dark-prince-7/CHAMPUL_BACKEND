...
const pieces = [
    { id: 'p01', name: 'Classic Tokens', category: 'piece', price: 0, rarity: 'common', metadata: { pieceSetId: 0 } },
    { id: 'p02', name: 'Neon Glow', category: 'piece', price: 300, rarity: 'rare', metadata: { pieceSetId: 1 } },
    { id: 'p03', name: 'Royal Gems', category: 'piece', price: 800, rarity: 'epic', metadata: { pieceSetId: 2 } },
    { id: 'p04', name: 'Glass Orbs', category: 'piece', price: 500, rarity: 'rare', metadata: { pieceSetId: 3 } },
    { id: 'p05', name: 'Wooden Coins', category: 'piece', price: 200, rarity: 'common', metadata: { pieceSetId: 4 } },
    { id: 'p06', name: 'Cyber Hex', category: 'piece', price: 1000, rarity: 'epic', metadata: { pieceSetId: 5 } },
    { id: 'p07', name: 'Candy Drops', category: 'piece', price: 250, rarity: 'common', metadata: { pieceSetId: 6 } },
    { id: 'p08', name: 'Star Tokens', category: 'piece', price: 400, rarity: 'rare', metadata: { pieceSetId: 7 } },
    { id: 'p09', name: 'Shield Crests', category: 'piece', price: 600, rarity: 'rare', metadata: { pieceSetId: 8 } },
    { id: 'p10', name: 'Pixel Blocks', category: 'piece', price: 350, rarity: 'common', metadata: { pieceSetId: 9 } },
    { id: 'p11', name: 'Chrome Rings', category: 'piece', price: 1200, rarity: 'epic', metadata: { pieceSetId: 10 } },
    { id: 'p12', name: 'Lotus Bloom', category: 'piece', price: 1500, rarity: 'epic', metadata: { pieceSetId: 11 } },
    { id: 'p13', name: 'Dragon Scale', category: 'piece', price: 2000, rarity: 'legendary', metadata: { pieceSetId: 12 } },
    { id: 'p14', name: 'Compass Rose', category: 'piece', price: 1800, rarity: 'epic', metadata: { pieceSetId: 13 } },
    { id: 'p15', name: 'Runic Sigil', category: 'piece', price: 2500, rarity: 'legendary', metadata: { pieceSetId: 14 } },
    { id: 'p16', name: 'Crown Jewels', category: 'piece', price: 3000, rarity: 'legendary', metadata: { pieceSetId: 15 } },
    { id: 'p17', name: 'Phoenix Wings', category: 'piece', price: 3500, rarity: 'legendary', metadata: { pieceSetId: 16 } },
    { id: 'p18', name: 'Samurai Crest', category: 'piece', price: 100000, rarity: 'legendary', metadata: { pieceSetId: 17 } },
    { id: 'p19', name: 'Cosmic Vortex', category: 'piece', price: 100000, rarity: 'legendary', metadata: { pieceSetId: 18 } },
    { id: 'p20', name: 'Ouroboros', category: 'piece', price: 120000, rarity: 'legendary', metadata: { pieceSetId: 19 } },
    { id: 'p21', name: 'Thunder Bolt', category: 'piece', price: 100000, rarity: 'legendary', metadata: { pieceSetId: 20 } },
    { id: 'p22', name: 'Sacred Scarab', category: 'piece', price: 150000, rarity: 'legendary', metadata: { pieceSetId: 21 } },
    { id: 'p23', name: 'Celestial Orb', category: 'piece', price: 120000, rarity: 'legendary', metadata: { pieceSetId: 22 } },
    { id: 'p24', name: 'Infinity Knot', category: 'piece', price: 100000, rarity: 'legendary', metadata: { pieceSetId: 23 } },
    { id: 'p25', name: 'Eternal Eye', category: 'piece', price: 180000, rarity: 'legendary', metadata: { pieceSetId: 24 } },
    { id: 'p26', name: 'Floating Lantern', category: 'piece', price: 100000, rarity: 'legendary', metadata: { pieceSetId: 25 } },
    { id: 'p27', name: 'Mechanical Gear', category: 'piece', price: 110000, rarity: 'legendary', metadata: { pieceSetId: 26 } },
    { id: 'p28', name: 'Ancient Totem', category: 'piece', price: 130000, rarity: 'legendary', metadata: { pieceSetId: 27 } },
    { id: 'p29', name: 'Diamond Cut', category: 'piece', price: 200000, rarity: 'legendary', metadata: { pieceSetId: 28 } },
    { id: 'p30', name: 'Viking Rune', category: 'piece', price: 150000, rarity: 'legendary', metadata: { pieceSetId: 29 } },
    { id: 'p31', name: 'Spirit Fox', category: 'piece', price: 160000, rarity: 'legendary', metadata: { pieceSetId: 30 } },
    { id: 'p32', name: 'Black Hole', category: 'piece', price: 250000, rarity: 'legendary', metadata: { pieceSetId: 31 } }
];
...
const avatars = [
    ...
    // ── New premium overhaul avatars ──
    { id: 'a14', name: 'Tiger Warlord',    category: 'avatar', price: 100000, rarity: 'legendary', description: 'Fearless Bengal tiger warlord — every opponent feels the claws before the roar. The apex predator of CHAMPUL.', metadata: { emoji: '🐯', frameFill: '#B45309', frameStroke: '#FCD34D', bgGrad: '#120800', shape: 'hexagon', badge: '⚔️' } },
    { id: 'a15', name: 'Crimson Demon',    category: 'avatar', price: 100000, rarity: 'legendary', description: 'Supreme demon lord forged in the seventh circle. All opposition crumbles before the crimson horns of dominion.',  metadata: { emoji: '😈', frameFill: '#9B1C1C', frameStroke: '#EF4444', bgGrad: '#1A0000', shape: 'diamond', badge: '💀' } },
    { id: 'a16', name: 'Abyssal Kraken',   category: 'avatar', price: 100000, rarity: 'legendary', description: 'Ancient sea titan that shattered fleets of warships. Eight tentacles, zero mercy. The deep answers to no one.', metadata: { emoji: '🐙', frameFill: '#1E3A5F', frameStroke: '#60A5FA', bgGrad: '#010a14', shape: 'circle',  badge: '🌊' } },
    { id: 'a17', name: 'Solar Titan',      category: 'avatar', price: 100000, rarity: 'legendary', description: 'Born from the corona of a dying star — temperature 15 million Kelvin, patience zero. The sun bows to this player.', metadata: { emoji: '☀️', frameFill: '#92400E', frameStroke: '#FDE68A', bgGrad: '#1a0e00', shape: 'hexagon', badge: '🌟' } },
    { id: 'a18', name: 'Neon Phantom',     category: 'avatar', price: 100000, rarity: 'legendary', description: 'Ghost of the cyber city — invisible in the grid, deadly in the matrix. Neon trails mark the path of absolute power.', metadata: { emoji: '👾', frameFill: '#5B21B6', frameStroke: '#A78BFA', bgGrad: '#06000F', shape: 'diamond', badge: '🕹️' } },
    { id: 'a19', name: 'War Bear',         category: 'avatar', price: 100000, rarity: 'legendary', description: 'Ancient spirit bear of the northern clans — painted in war glyphs, forged through 1000 battles in frozen tundra.', metadata: { emoji: '🐻', frameFill: '#44403C', frameStroke: '#D6D3D1', bgGrad: '#0c0a08', shape: 'hexagon', badge: '🗡️' } },
    { id: 'a20', name: 'Storm Vortex',     category: 'avatar', price: 100000, rarity: 'legendary', description: 'Category 6 storm system given consciousness. The vortex consumes everything — boards, pieces, opponents, hope.',    metadata: { emoji: '🌪️', frameFill: '#374151', frameStroke: '#9CA3AF', bgGrad: '#08090c', shape: 'diamond', badge: '⚡' } },
    { id: 'a21', name: 'Arcane Witchlord', category: 'avatar', price: 100000, rarity: 'legendary', description: 'Ancient witch sorcerer who rewrites the laws of probability. Your dice rolls are already decided — against you.',     metadata: { emoji: '🪄', frameFill: '#7E22CE', frameStroke: '#DDD6FE', bgGrad: '#0c0018', shape: 'hexagon', badge: '🔮' } },
    { id: 'a22', name: 'Iron Empress',     category: 'avatar', price: 100000, rarity: 'legendary', description: 'Fortress sovereign in diamond-tempered iron — strategy as weapon, patience as armour. Walls that never fall.',       metadata: { emoji: '🛡️', frameFill: '#1F2937', frameStroke: '#C0C0C0', bgGrad: '#050608', shape: 'diamond', badge: '👑' } },
    { id: 'a23', name: 'Blood Moon',       category: 'avatar', price: 100000, rarity: 'legendary', description: 'The lunar sovereign during total eclipse — crimson moon energy intensified to a weapon. Tides obey its command.', metadata: { emoji: '🌑', frameFill: '#7F1D1D', frameStroke: '#FCA5A5', bgGrad: '#0d0101', shape: 'circle',  badge: '🩸' } },
    { id: 'a24', name: 'Obsidian Serpent', category: 'avatar', price: 100000, rarity: 'legendary', description: 'Thousand-year cobra of volcanic obsidian — venom crystallised at 1300°C. One fang touch ends civilisations.',       metadata: { emoji: '🐍', frameFill: '#064E3B', frameStroke: '#34D399', bgGrad: '#010d07', shape: 'hexagon', badge: '💚' } },
    { id: 'a25', name: 'Eternal Samurai',  category: 'avatar', price: 100000, rarity: 'legendary', description: 'Ronin who has transcended death — the undying blade cuts through time itself. Bushido given immortal form.',         metadata: { emoji: '⚔️', frameFill: '#1C1917', frameStroke: '#E7E5E4', bgGrad: '#090808', shape: 'diamond', badge: '🌸' } },
];
